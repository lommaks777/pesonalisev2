...
ФОРМАТ ОТВЕТА (JSON с emoji-ключами):
{
  ...
  "⚠️ Важно": ["примечание 1", "примечание 2"], // опционально, только если есть в транскрипте
  "🧰 Инвентарь и подготовка": "список оборудования и тайминг", // опционально
...
// Соответствие номер → стабильный ID
function getLessonId(lessonNumber: number): string {
  ...
  return map[lessonNumber] || String(lessonNumber);
}
